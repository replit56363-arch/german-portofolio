      ...
      <header className="relative z-30 border-b border-[#173d3a]/15 bg-[#f5eee3]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1240px] items-center justify-between px-5 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 md:flex" aria-label="Navigasi landing">
            ...
            <button type="button" onClick={() => navTo("layanan")} className="font-mono-ui text-[10px] font-bold uppercase tracking-[0.15em] text-[#486961] transition-colors hover:text-[#d35f46]">Layanan</button>
            <button type="button" onClick={() => navTo("kabar")} className="font-mono-ui text-[10px] font-bold uppercase tracking-[0.15em] text-[#486961] transition-colors hover:text-[#d35f46]">Kabar terkini</button>
