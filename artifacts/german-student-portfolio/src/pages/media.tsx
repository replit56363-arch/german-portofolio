...
type MediaCategory = "Semua" | "Televisi" | "Dokumenter" | string;
...
export default function Media() {
  ...
  return (
    <div className="min-h-[100dvh] overflow-hidden bg-[#f5eee3] text-[#173d3a]">
      <PublicNavbar activeRoute="/media" />
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {featuredItems.map((item) => (
                <article key={item.id} className="group">
                  <MediaArtwork item={item} featured />
                  ...
                  <h2 className="mt-3 font-['Fraunces'] text-2xl font-semibold leading-[1.02] tracking-[-0.045em] text-[#173d3a] transition-colors group-hover:text-[#d35f46]">
                    {item.title}
                  </h2>
                </article>
              ))}
              ...
              <div className="mt-12 grid gap-x-5 gap-y-14 md:grid-cols-2 lg:grid-cols-3">
                {visibleItems.map((item) => (
                  <article key={item.id} className="group">
                    ...
                    <p className="mt-3 font-mono-ui text-[10px] font-bold uppercase tracking-[0.12em] text-[#d35f46]">{item.channel}</p>
                    <h3 className="mt-2 font-['Fraunces'] text-2xl font-semibold leading-[1.02] tracking-[-0.04em] text-[#173d3a] transition-colors group-hover:text-[#d35f46]">
                      {item.title}
                    </h3>
