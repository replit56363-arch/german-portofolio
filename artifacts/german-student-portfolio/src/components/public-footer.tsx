...
const defaultFooterData = {
  ...
  links: [
    ...
    { id: 4, label: "Data Siswa", href: "/siswa", category: "Navigasi" },
    { id: 5, label: "Foto Alumni", href: "/alumni", category: "Navigasi" },
    { id: 6, label: "Ruangan Kelas", href: "/ruangan-kelas", category: "Navigasi" },
    { id: 7, label: "Kabar Terbaru", href: "/berita", category: "Informasi" },
    { id: 8, label: "Kisah Referensi", href: "/referensi", category: "Informasi" },
    { id: 9, label: "Hubungi WhatsApp", href: "https://wa.me/6282127324453", category: "Kontak" },
    { id: 10, label: "Portal Admin", href: "/login", category: "Kontak" },
  ],
  socialLinks: [
