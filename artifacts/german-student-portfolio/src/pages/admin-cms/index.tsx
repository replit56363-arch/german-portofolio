...
export default function CmsOverviewPage() {
  ...
  const pages = [
    ...
    },
    {
      ...
      description: "Daftar siswa & kandidat aktif, level bahasa (A1–B2), angkatan, status dan penempatan ke Jerman.",
      path: "/admin/cms/students",
      publicPath: "/siswa",
      icon: Users,
      color: "bg-[#eff6ff] text-[#1e40af] border-[#bfdbfe]",
      badge: "Data Siswa",
      count: "Direktori & Filter Level",
    },
    {
      id: "alumni",
      title: "Halaman Foto Alumni",
      description: "Dokumentasi foto nyata para alumni di Jerman, program Ausbildung/Au Pair/FSJ/G to G/Kuliah.",
      path: "/admin/cms/alumni",
      publicPath: "/alumni",
      icon: Sparkles,
      color: "bg-[#fdf4ff] text-[#86198f] border-[#f5d0fe]",
      badge: "Galeri Alumni",
      count: `${cmsData?.alumni?.items?.length || 0} Foto Alumni`,
    },
    {
      id: "classrooms",
      title: "Halaman Ruangan Kelas",
      description: "Sarana belajar ber-AC, lab multimedia audio Hören Goethe-Institut, smart screen TV kampus Medan Polonia.",
      path: "/admin/cms/classrooms",
      publicPath: "/ruangan-kelas",
      icon: Layers,
      color: "bg-[#f0fdf4] text-[#166534] border-[#bbf7d0]",
      badge: "Fasilitas Kampus",
      count: `${cmsData?.classrooms?.items?.length || 0} Ruangan & Lab`,
    },
    {
      id: "news",
